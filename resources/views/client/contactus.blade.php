        ...
        <div class=container>
                        ...
                        <div class="collapse navbar-collapse" id=coffeeNavbarPrimary>
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li><a href=shopcart.html>Cart <i class="fa fa-shopping-cart"><span
                                                class=cartitems>42</span></i></a></li>
            ...
            <div class="banner clearfix">
                ...
                <div class=banner-text>
                    <h2>Our special & exclusive <span>contact us</span></h2>
                </div>
            </div>
        </div>
        ...
        <div class=container>
            ...
            <div class=cont-wrap>
                <div class="addressbar row">
                    <div class="marker clearfix"> <a href=#> <i class="fa-solid fa-location-dot"></i> </a>
                        <div class=cont>
                            <h4>102 / Cappuccino city</h4>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
                        </div>
                    </div>
                    <div class="support-mail clearfix"> <a href=#> <i class="fa fa-envelope"></i> </a>
                        <div class=cont>
                ...
                <div class="mapwrapper row">
                    <div id=map-canvas1 >
                        <iframe style="width:759.6px; height:450px" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3723.658663641744!2d105.78131221451449!3d21.046339485988884!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3135ab3b4220c2bd%3A0x1c9e359e2a4f618c!2sB%C3%A1ch%20Khoa%20Aptech!5e0!3m2!1svi!2s!4v1661452378322!5m2!1svi!2s" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    </div>
                </div>
            </div>
            <div class=leave-comment>
                ...
                <form id=contactform data-parsley-validate>
                    <div class=form-group> <input type=text class=form-control placeholder=Name name=name required>
                    </div>
                    <div class=form-group> <input type=email class=form-control placeholder="Email Id" name=email
                            required> </div>
                    <div class=form-group> <input type=text class=form-control placeholder=Subject name=usersubject
                            required> </div> <textarea placeholder=Message class=textarea name=message
                        required></textarea> <button type=submit>post comment</button>
