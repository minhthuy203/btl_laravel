...
<head>
    ...
    <!-- Daterange picker -->
    <link rel="stylesheet" href="{{url('public/admin')}}//plugins/daterangepicker/daterangepicker-bs3.css">
...
<body class="hold-transition skin-blue sidebar-mini">
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <img src="{{url('public/admin')}}/dist/img/user2-160x160.jpg" class="user-image"
                                    alt="User Image">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header">
                                    <img src="{{url('public/admin')}}/dist/img/user2-160x160.jpg" class="img-circle"
                                        alt="User Image">
                                ...
                                <li class="user-footer">
                                    ...
                                    <div class="pull-right">
                                        <a href="{{route('admin.logout')}}" class="btn btn-default bbtn-flat">Sign out</a>
                                    </div>
                                </li>
                            </ul>
                        </li>
    ...
    <!-- jQuery 2.2.0 -->
    <script src="{{url('public/admin')}}/plugins/jQuery/jQuery-2.2.0.min.js"></script>
    <!-- jQuery UI 1.11.4 -->
